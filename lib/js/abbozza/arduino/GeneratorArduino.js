...
AbbozzaGenerator.prototype.workspaceToCode = function(opt_workspace) {
  ...
  if ( this.serialParserRequired == true ) {
     ...
     this.addPreSetup("AbbozzaParser __serial_parser = AbbozzaParser();");
  }

    if ( this.parserRequired == true ) {
     this.addLibrary("abbozzaStringParser.h");
     this.addPreSetup("AbbozzaStringParser __parser = AbbozzaStringParser();");
  }
  ...
  code = code.replace(/###inithook###/g,this.preSetup);
  ...
  code = code.replace(/###libraries###/g,acode);
