...
/**
 * Initialize the Arduino as I2CS Master
 * 
 * @type type
 */
...
/**
 * Initialize the Arduino as I2CS Slave with given address
 * @type type
 */
 ...
 * @type type
 */
Abbozza.DeviceI2CSMasterSendString = {
    init: function () {
        this.setHelpUrl(Abbozza.HELP_URL);
        this.setColour(ColorMgr.getColor("cat.I2CS"));
                
        this.appendValueInput("ADDRESS")
                .appendField(__("dev.I2CS_MASTER_SEND_STRING",0))        
                .setCheck("NUMBER");
        this.appendValueInput("VALUE")
                .appendField(__("dev.I2CS_MASTER_SEND_STRING",1))
                .setCheck("STRING");
        this.setInputsInline(true);
        this.setOutput(false);
        this.setPreviousStatement(true, "STATEMENT");
...
Blockly.Blocks['dev_i2cs_master_send_string'] = Abbozza.DeviceI2CSMasterSendString;
 ...
 * @type type
 */
Abbozza.DeviceI2CSWriteString = {
    init: function () {
        this.setHelpUrl(Abbozza.HELP_URL);
        this.setColour(ColorMgr.getColor("cat.I2CS"));
                
        this.appendValueInput("ADDRESS")
                .appendField(__("dev.I2CS_WRITE_STRING",0))        
                .setCheck("NUMBER");
        this.appendValueInput("VALUE")
                .appendField(__("dev.I2CS_WRITE_STRING",1))
                .setCheck("STRING");
        this.setInputsInline(true);
        this.setOutput(false);
        this.setPreviousStatement(true, "STATEMENT");
...
Blockly.Blocks['dev_i2cs_write_string'] = Abbozza.DeviceI2CSWriteString;
...
Abbozza.DeviceI2CSOnReceive = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(__("dev.I2CS_RECEIVE",1));
    this.setInputsInline(true);   
...
Abbozza.DeviceI2CSOnRequest = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new FunctionDropdown(this, null,true), "ISR")
    	.appendField(__("dev.I2CS_REQUEST",1));
    this.setInputsInline(true);   
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('');
