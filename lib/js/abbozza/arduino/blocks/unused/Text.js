 ...
 * Returns a string consisting of the character with the given ascci code
 */
Abbozza.ASCIIFromText2 = {
  init: function() {
    this.setHelpUrl(Abbozza.HELP_URL);
    this.setColour(ColorMgr.getCatColor("cat.TEXT"));
    this.appendValueInput("TEXT")
        .appendField(__("txt.ASCIIFROMTEXT2",0))
        .setCheck(["STRING"]);
    this.appendValueInput("POS")
        .appendField(__("txt.ASCIIFROMTEXT2",1))
        .setCheck(["NUMBER"]);
    this.setInputsInline(true);
    this.setOutput(true, "NUMBER");
    this.setTooltip('');
...
Blockly.Blocks['ascii_from_text2'] = Abbozza.ASCIIFromText;
