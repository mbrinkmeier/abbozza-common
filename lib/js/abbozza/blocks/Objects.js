...
Abbozza.VariableStack = {
    init: function () {
        ...
        this.appendDummyInput()
                ...
                .appendField(new Blockly.FieldDropdown( Abbozza.getTypeMenu() ), "TYPE")
...
Abbozza.StackNew = {
    ...
    init: function () {
        ...
        this.appendDummyInput()
                ...
                .appendField(new Blockly.FieldDropdown( Abbozza.getTypeMenu(), 
                        function (name) {
    ...
    mutationToDom: function () {
       ...
       mutation.setAttribute("type","#STACK_" + this.getFieldValue("TYPE"));
       return mutation;
    },  
...
Abbozza.QueueNew = {
    ...
    mutationToDom: function () {
       var mutation = document.createElement('mutation');
       mutation.setAttribute("type","#QUEUE_" + this.getFieldValue("TYPE"));
       return mutation;
    },  
    domToMutation: function (xmlElement) {
       if ( xmlElement.hasAttribute("type") ) {
...
Abbozza.ListNew = {
    ...
    mutationToDom: function () {
       var mutation = document.createElement('mutation');
       mutation.setAttribute("type","#LIST_" + this.getFieldValue("TYPE"));
       return mutation;
    },  
    domToMutation: function (xmlElement) {
       if ( xmlElement.hasAttribute("type") ) {
...
Abbozza.BinTreeNew = {
    ...
    mutationToDom: function () {
       var mutation = document.createElement('mutation');
       mutation.setAttribute("type","#BINTREE_" + this.getFieldValue("TYPE"));
       return mutation;
    },  
    domToMutation: function (xmlElement) {
       if ( xmlElement.hasAttribute("type") ) {
...
Abbozza.BinTreeGetData = {
    ...
    onload: function () {
        ...
        if (symbol) {
            ...
            this.setOutput(true, Abbozza.getTypes());
        }
    }
};
